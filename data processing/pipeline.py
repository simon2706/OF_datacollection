...
path_to_csv = r"C:\Users\kipri\OneDrive\Documents\EmteqLabs\EmteqVR Open Face System\Upload\Participant 01\TaskA\2022-04-28T12-31-47.csv"
...
df['accelerometer_magnitude'].plot(figsize=(15, 3))
...
max_acc_mag = df['accelerometer_magnitude'].max()
